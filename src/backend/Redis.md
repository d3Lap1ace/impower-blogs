...
![](image%5Cimage-20230706115650664.png#id=nQ7jr&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
-  执行完毕再次查看主从配置信息
![](image%5Cimage-20230706185658801.png#id=OqyoW&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=) 

### （8）测试主从读写操作

-  主机上写入数据OK 
-  在从机上写数据报错
![](image%5C%E5%9B%BE%E7%89%87_GQz6WElSh0.png#id=cUbye&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=) 
...
![](image%5C%E5%9B%BE%E7%89%87_ARh2hxM4BZ.png#id=dqRgF&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5C%E5%9B%BE%E7%89%87_r1ItTkr3yQ.png#id=xQ6lM&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5C%E5%9B%BE%E7%89%87_Ph7uZJfPCr.png#id=zttX8&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5C%E5%9B%BE%E7%89%87_b9dFKRgmDO.png#id=xWZwB&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5C%E5%9B%BE%E7%89%87_P-N3sLBZXe.png#id=Qohgo&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706190854461.png#id=AucIr&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5C%E5%9B%BE%E7%89%87_ZAx9ym8HMa.png#id=zsbmV&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706200218897.png#id=On4qX&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=) 

### （3）第三步,启动六个服务

![](image%5Cimage-20230706200143345.png#id=Na4TV&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 组合之前，请确保所有redis实例启动后，nodes-xxxx.conf文件都生成正常。

![](image%5Cimage-20230706200315643.png#id=yVSGZ&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706200816752.png#id=e3aRb&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

输入 yes 继续

![](image%5Cimage-20230706200954694.png#id=F1H4P&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

## 9.4集群的登录

### （1）集群登录方式

![](image%5C%E5%9B%BE%E7%89%87_afL9Hz385B.png#id=ss4eJ&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706201216761.png#id=pzsJ7&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

## 9.5 集群的slots

![](image%5Cimage-20230706201426691.png#id=rKQU4&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706201647379.png#id=AAclB&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

-  不在一个slot下的键值，是不能使用mget,mset等多键操作。 
-  可以通过{}来定义组的概念，从而使key中{}内相同内容的键值对放到一个slot中去。 

![](image%5Cimage-20230706201756159.png#id=c2zSr&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
...
![](image%5Cimage-20230706202007674.png#id=AU5tc&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

## 9.8 集群故障恢复

- 如果主节点下线？从节点能否自动升为主节点？注意：**15秒超时**

![](image%5Cimage-20230706202459470.png#id=Crbsj&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)

- 主节点恢复后，主从关系会如何？主节点回来变成从机。

![](image%5Cimage-20230706202640635.png#id=tRSYy&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
